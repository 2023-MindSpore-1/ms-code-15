...
optimizer = "Momentum"
pretrainedmodel = {
    "res2net50": "./checkpoints/res2net50_ascend_v190_imagenet2012_research_cv_top1acc78_top5acc94.ckpt"
}
...
class Residual2Block(nn.Cell):
    ...
    def __init__(
        ...
        if optimizer == "Thor" or net_name == "res2net152":
...
def res2net50(pretrained=False, class_num=1001):
    """
    ...
    if pretrained:
        # load checkpoint
        param_dict = load_checkpoint(pretrainedmodel["res2net50"])
...
if __name__ == '__main__':
    ...
    net = res2net50(class_num=1001)
    # load checkpoint
    # param_dict = load_checkpoint("/home/ubuntu/.mscache/mindspore/1.9/res2net50_ascend_v190_imagenet2012_research_cv_top1acc78_top5acc94.ckpt")
